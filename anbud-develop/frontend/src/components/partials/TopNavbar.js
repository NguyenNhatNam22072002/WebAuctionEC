  ...
  return (
    <Container className="px-0 bg-light bg-gradient rounded-bottom shadow" fluid >
      ...
      <Navbar light expand="md" className="mb-0">
        <Link to="/" className="mr-auto navbar-brand text-success font-weight-bold mb-0 pt-2 pb-0"><h3>Auction</h3></Link>
        ...
        <Collapse isOpen={isOpen} navbar>
          ...
          {!user?(
            ...
            <div className="mt-1 d-lg-flex">
              ...
              <NavItem>
                <Link className="text-dark mx-lg-4" to="/listauction">LIST AUCTIONS</Link>
              </NavItem>
              <NavItem>
